...
CREATE TABLE data_table (column_1 INT, column_2 INT, column_3 INT, id INT, PRIMARY KEY (id));
INSERT INTO data_table (column_1,column_2,column_3,id)
VALUES (10,5,101,1),
(10,5,102,2),
(10,5,103,3),
(10,5,104,4),
...
CREATE TABLE email_table (id INT, email VARCHAR(255), FOREIGN KEY (id) REFERENCES data_table(id));
INSERT INTO email_table (id,email)
VALUES
...
JOIN data_table ON email_table.id = data_table.id
WHERE (column_1/2) LIKE '%.0%' AND column_2 < column_1 AND column_3 LIKE '%1'
